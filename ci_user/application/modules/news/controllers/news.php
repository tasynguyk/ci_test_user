	...
	public function index($page = 1)
	{
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        $lang_list = $this->input->post('lang');
                        $this->session->set_userdata('lang_list',$lang_list);
                        redirect(base_url().'index.php/news/news', 'location');
                    }
                    ...
                    if($this->session->userdata('lang_list'))
                    {
                        $lang_list = $this->session->userdata('lang_list');
                    }
                    else
                    {
                        $lang_list = 'en';
